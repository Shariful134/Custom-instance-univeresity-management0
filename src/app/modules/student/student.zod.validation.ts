...
const studentSchemaValidationZod = z.object({
  ...
  name: userSchema.refine((name) => !!name, { message: 'name is required' }),
  ...
  gurdian: guardianSchema.refine((guardian) => !!guardian, {
    message: 'gurdian is required',
  }),
  localGurdian: localGurdianSchema.refine((localGurdian) => !!localGurdian, {
